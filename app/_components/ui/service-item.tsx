              ...
              <div className="flex items-center justify-between">
                ...
                <Sheet>
                  ...
                  <SheetContent className="px-0">
                   ...
                   {selectedDay && (
                    <div className="p-5 border-b border-solid gap-3 flex overflow-auto [&::-webkit-scrollbar]:hidden">
                    {TIME_LIST.map((time) => (
                      <Button 
                   ...
                   {selectedTime && selectedDay && (
                      ...
                      <Card>
                        <CardContent className="p-3 space-y-3">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <p className="text-sm">
                              {formatDate(selectedDay, "d 'de' MMMM", {locale: ptBR})}
                            </p>
                          </div>
                    ...
                    <SheetFooter className="px-5 mt-5">
                        <SheetClose asChild>
                          <Button onClick={handleCreateBooking} type="submit" disabled={!selectedDay || !selectedTime}>Confirmar</Button>
                        </SheetClose>
                      </SheetFooter>
                  </SheetContent>
                </Sheet>
